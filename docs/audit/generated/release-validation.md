...
Versión del árbol: `3.73.5` · **10 pass · 0 fail · 0 skip**
...
|---|---|---|---|
| 1 | La versión es consistente en todos los orígenes | ✅ pass | OK: Release consistency (3.73.5) en todos los orígenes |
