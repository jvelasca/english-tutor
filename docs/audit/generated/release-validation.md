...
Versión del árbol: `3.86.0` · **10 pass · 0 fail · 0 skip**
...
|---|---|---|---|
| 1 | La versión es consistente en todos los orígenes | ✅ pass | OK: Release consistency (3.86.0) en todos los orígenes |
...
| 8 | Los 8 gates están definidos y documentados | ✅ pass | 8 gates declarados |
| 9 | El artefacto de la UI está construido | ✅ pass | index.html servible |
| 10 | La evidencia registrada es válida | ✅ pass | sin evidencia todavía (los 8 gates están en `pending`) |

Los 8 gates de validación física se registran con `validation_gate.py record` (que sella el commit validado) y se consultan con `status --strict`; con los 8 en `pass`, `status --strict --same-tree` exige además que la evidencia sea de este mismo commit.
