...
>
> **Actualización (v3.5.0):** los P2 8–10 de la Constitución (§9) se ejecutaron
> en la UI. Estado de los hallazgos: H1–H7 **cerrados**. El detalle está en la
> columna "Estado" de cada hallazgo.
>
...
- `frontend/src/utils/modes.test.ts` — fijaba `modeCefrLevel/modeCefrBand`, código **sin uso** en componentes (H7); eliminado en v3.5.0 (P2-10).
