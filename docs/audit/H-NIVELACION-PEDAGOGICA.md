...
> **parciales**; H4 abierto. El detalle está en la columna "Estado" de cada
> hallazgo (los *estados observados* de este dossier describen la foto V3.2.1
> previa a esa iteración).
