/**
 * Sesiones de práctica de Pronunciation por rutas (V3.9), espejo de
 * listening/speaking.
 *
...
export function drillDone(session: PronunciationSession): number {
...
export function sessionDone(session: PronunciationSession): number {
...
export function isSessionFinished(session: PronunciationSession): boolean {
