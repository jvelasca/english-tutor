...
- **Verificación local.** `pytest` **2223 passed** (142,8 s), `ruff` limpio, `check_release_consistency` **3.55.0**. En CI se esperan **2221 passed + 2 skipped** (los 2 de `test_stt_asr_integration.py`, opt-in del modelo Whisper no descargado en el runner).
