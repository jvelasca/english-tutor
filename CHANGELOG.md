...
- **E · Tests y gates.** Backend **2694 passed** (2643 → **+51**, los 5 ficheros `*_v372.py`), frontend **699 passed** (83 ficheros, 661 → **+38**), launcher **93 passed** (75 → **+18**, sigue en CI), `ruff` limpio en backend y launcher, `tsc` limpio, `npm run build` OK, `check_release_consistency.py` verde en los **6 orígenes** de versión, `check_beta_v3.py`/`content_validation`/`transfer_validation` OK. **8/8 jobs de CI** con el job nuevo `product-origin`.
